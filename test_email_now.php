...
<body>
    ...
    <p>SMTP2GO Credentials: playsmart.co.in / PCERlViy6D9psPFZ</p>
</body>
</html>
';
...
if (file_exists('smtp2go_config.php')) {
    ...
    echo "   Using hardcoded credentials from process_payment.php\n";
}
...
echo "\n🎯 Next steps:\n";
echo "1. Check if you received the test email\n";
echo "2. If email received: SMTP2GO is working\n";
echo "3. If email not received: Check server logs and SMTP2GO dashboard\n";
echo "4. Test the complete payment flow in the Flutter app\n";
