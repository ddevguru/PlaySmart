    ...
    if (_formKey.currentState!.validate()) {
      ...
      try {
        final response = await http.post(
          Uri.parse('https://playsmart.co.in/signup.php'),
        ...
        try {
          ...
          if (response.statusCode == 200 && data['success']) {
            ...
            if (mounted) {
              // Uncomment and update MainScreen path when ready
            ...
            _showErrorSnackBar(data['message'] ?? 'Signup failed with status ${response.statusCode}');
          }
        } catch (e) {
